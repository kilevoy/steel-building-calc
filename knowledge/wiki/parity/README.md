...
Структурный ingest Excel-источника подкрановой балки описан в `excel-006-crane-beam.md`.

Обезличенные ingest-страницы КМ-проектов описаны в `km-002-km1.md` и `km-003-km.md`.
