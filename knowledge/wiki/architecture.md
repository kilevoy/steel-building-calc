...
## Продольные оси здания

Продольная разбивка хранится как геометрическая модель осей и пролётов. Поддерживаются:

- равномерный шаг рам для длины, кратной шагу;
- центральные пролёты с общим шагом и два симметричных торцевых пролёта.

Количество рам, внутренних колонн, ферм и физическая штучность разрезных прогонов
должны выводиться из одной модели осей. Центральный шаг остаётся расчётным пролётом
для подбора элементов; влияние отличающихся торцевых пролётов на отдельный подбор
профилей требует самостоятельного инженерного сценария, если торцевой пролёт больше
центрального.
