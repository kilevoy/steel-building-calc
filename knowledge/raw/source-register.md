...
| EXCEL-011 | Excel oracle | Калькулятор стоимости проектных работ ИНСИ (R2) | knowledge/raw/excel/project-work/ | структура описана | сверка стоимости/срока проектных работ КМ (только конструктив «Великан») | файл не коммитится, защищён knowledge/raw/.gitignore; см. knowledge/wiki/parity/excel-011-project-work.md |
...
| KM-002 | КМ project | КМ1.pdf | knowledge/raw/km-projects/drawings/ | структура описана | проверка практических решений и состава КМ | файл не коммитится, защищён knowledge/raw/.gitignore; см. knowledge/wiki/parity/km-002-km1.md |
| KM-003 | КМ project | KM.pdf | knowledge/raw/km-projects/drawings/ | структура описана | проверка практических решений и состава КМ | файл не коммитится, защищён knowledge/raw/.gitignore; см. knowledge/wiki/parity/km-003-km.md |
| KM-004 | КМ / frame type PDF | Великан односкатный.pdf | knowledge/raw/km-projects/examples/velican-frame-types/ | добавлен локально | типовые схемы каркаса для раздела "Единое здание" | файл не коммитится, защищён knowledge/raw/.gitignore; см. knowledge/wiki/parity/km-004-velican-frame-types.md |
| KM-005 | КМ / frame type PDF | Великан односкатный 2 пролета.pdf | knowledge/raw/km-projects/examples/velican-frame-types/ | добавлен локально | типовые схемы каркаса для раздела "Единое здание" | файл не коммитится, защищён knowledge/raw/.gitignore; см. knowledge/wiki/parity/km-004-velican-frame-types.md |
| KM-006 | КМ / frame type PDF | Великан 2 пролета.pdf | knowledge/raw/km-projects/examples/velican-frame-types/ | добавлен локально | типовые схемы каркаса для раздела "Единое здание" | файл не коммитится, защищён knowledge/raw/.gitignore; см. knowledge/wiki/parity/km-004-velican-frame-types.md |
| KM-007 | КМ / frame type PDF | Великан 3 пролета.pdf | knowledge/raw/km-projects/examples/velican-frame-types/ | добавлен локально | типовые схемы каркаса для раздела "Единое здание" | файл не коммитится, защищён knowledge/raw/.gitignore; см. knowledge/wiki/parity/km-004-velican-frame-types.md |
| KM-008 | КМ / frame type PDF | Великан 3 пролета вдоль.pdf | knowledge/raw/km-projects/examples/velican-frame-types/ | добавлен локально | типовые схемы каркаса для раздела "Единое здание" | файл не коммитится, защищён knowledge/raw/.gitignore; см. knowledge/wiki/parity/km-004-velican-frame-types.md |
| KM-009 | КМ / frame type PDF | Великан 4 пролета.pdf | knowledge/raw/km-projects/examples/velican-frame-types/ | добавлен локально | типовые схемы каркаса для раздела "Единое здание" | файл не коммитится, защищён knowledge/raw/.gitignore; см. knowledge/wiki/parity/km-004-velican-frame-types.md |
| KM-010 | КМ / frame type PDF | Великан с антресолью.pdf | knowledge/raw/km-projects/examples/velican-frame-types/ | добавлен локально | типовые схемы каркаса для раздела "Единое здание" | файл не коммитится, защищён knowledge/raw/.gitignore; см. knowledge/wiki/parity/km-004-velican-frame-types.md |
