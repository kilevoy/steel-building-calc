...
function buildCellValues(inputs: ProjectWorkInputs): Record<string, string | number | boolean> {
  const values: Record<string, string | number | boolean> = {
    ...
    partitionGvlArea: inputs.partitionGvlArea,
    partitionSandwichLayeredArea: inputs.partitionSandwichLayeredArea,
    partitionSandwichFactoryArea: inputs.partitionSandwichFactoryArea,
